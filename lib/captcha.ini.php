...
return [
    ...
    'iconPath' => dirname(__FILE__) . '/vendor/fabianwennink/iconcaptcha/assets/icons',
    ...
    'challenge' => [
        ...
        'iconAmount' => [
            'min' => 6, // The lowest possible is 5 icons per challenge.
            'max' => 7 // The highest possible is 8 icons per challenge.
        ],
