...
define('LANG_FORMFIELD_ERRORS', array(
    ...
    'mandatory_select' => 'Selection required!',
    'mandatory_checkbox' => 'Selection required!',
...
define('LANG_LOGOUT_FROM_ALL', 'logout from all devices');